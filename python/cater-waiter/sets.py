...
def tag_special_ingredients(dish):
    ...
    note on the dish description. For the purposes of this exercise, all allergens or
    special ingredients that need to be tracked are in the SPECIAL_INGREDIENTS constant
...
def compile_ingredients(dishes):
    ...
    return set(functools.reduce(lambda a, b: a | b, dishes))
...
def singleton_ingredients(dishes, intersection):
    ...
    all_ingredients = set(functools.reduce(lambda a, b: a | b, dishes))
